...
public class CreateNewPostByApi {
    ...
    @Before
    public void getTokenDeletePosts() {
    ...
    public void createNewPostByApi() {
        ...
        Assert.assertEquals("Number of posts Before+1 and After create new post ",
                numberOfPosts + 1, numberOfPostsAfterCreatingPost);
    ...
    private int getNumberOfPostsByUser() {
        return apiHelper.getAllPostByUserRequest().extract().body().as(PostsDto[].class).length;
    }
}
