...
//        Фільтрація та виведення елементів списку: Створіть список рядків.
//        Використовуйте Stream API для фільтрації та виведення всіх рядків,
//        які починаються на певну літеру (наприклад, "a").
