...
public class CreateNewPostByApi {
    ...
    public void createNewPostByApi() {
        ...
        Assert.assertEquals("Number of posts Before+1 and After creating new post ", numberOfPosts + 1, numberOfPostsAfterCreatingPost);
       ...
       PostsDto expectedPostDto = PostsDto.builder()
        ...
        softAssertions.assertThat(apiHelper.getAllPostByUserRequest().extract()
                        .body().as(PostsDto[].class)[0]).usingRecursiveComparison()
